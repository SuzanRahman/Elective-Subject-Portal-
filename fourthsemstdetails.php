...
<body>
    ...
    if (isset($_SESSION['login_user'])) {
        ...
        $stmt = $pdo->prepare("SELECT Roll, Name, Semester, Elective_3, Elective_4 FROM formdetails WHERE Semester = '4th'");
        $stmt->execute();
        ...
        foreach ($result as $row) {
            ...
            echo "<td>" . $row['Elective_3'] . "</td>";
            echo "<td>" . $row['Elective_4'] . "</td>";
            echo "</tr>";
        }
