    ...
    <div class="container">
      ...
      <form action="php1/feedback.php" method="post" class="student-form">
        ...
        <div class="student-feedback">
          <h5>-------For 3RD Semester-------</h5>
          
          <h4>
            Elective 1
          </h4>
          <label>
          <input type="radio" name="Elective_1" value="Machine Learning">Machine Learning
          </label>
          <label>
          <input type="radio" name="Elective_1" value="Ecommerce and ERP">Ecommerce and ERP
          </label>
          <label>
          <input type="radio" name="Elective_1" value="Cloud Computing">Cloud Computing
          </label>
          <label>
          <input type="radio" name="Elective_1" value="Mobile Computing">Mobile Computing
          </label>
          <br /><br />
          ...
          <label>
          <input type="radio" name="Elective_2" value="Cryptography and Network Security">Cryptography and Network Security
          </label>
          <label>
          <input type="radio" name="Elective_2" value="Automata Theory and Compiler Design">Automata Theory and Compiler Design
          </label>
          <label>
          <input type="radio" name="Elective_2" value="Natural Language Processing">Natural Language Processing
          </label>
          <label>
          <input type="radio" name="Elective_2" value="Managerial Economics">Managerial Economics
          </label>
          <br /><br />
